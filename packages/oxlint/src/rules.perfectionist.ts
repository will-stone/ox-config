...
export const rulesPerfectionist: Record<string, DummyRule> = {
  ...
  "perfectionist/sort-jsx-props": [
    "error",
    {
      customGroups: [
        {
          // Same sorting as react/jsx-sort-props with the reservedFirst option.
          // https://github.com/jsx-eslint/eslint-plugin-react/blob/c9a2de775bdc704d3be416193cb28db0017c7f8b/lib/rules/jsx-sort-props.js#L42
